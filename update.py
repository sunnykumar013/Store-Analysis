...
class Database:
    def __init__(self,master,*args,**kwargs):
        ...
        self.master=master
        self.heading = Label(master, text = "Update the database", font=("arial 40 bold"),fg='steel blue')
        ...
        self.stock_l = Label(master,text ="enter item available",font=('arial 18 bold'))
    ...
    def search(self,*args,**kwargs):
        ...
        #insert into the entries to updates
